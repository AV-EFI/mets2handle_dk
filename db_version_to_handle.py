...
'''
This module is Designed to map the Values from the METS XML files to the values in the Handle System
For that each function is a mapping which seaches for the value in a section of the METS file and puts it in a Dictionary which has the format of 
